...
export const DESKTOP_CONTRACT_DIGEST = "sha256:d4c01376af49b9806022755989bcc94e77da7499622a958ccd8425945feb6281";
...
export interface ReasoningAuditTotals {
  audited: boolean;
  elapsedMs: number;
...
export interface GeneratedDesktopCommands {
  ...
  OptimizePrompt(arg0: string): Promise<string>;
  ...
  PruneTasks(arg0: string, arg1: number): Promise<PruneResult>;
  ...
  SetAuditEnabled(arg0: boolean): Promise<void>;
  ...
  SetPromptOptimizeModel(arg0: string): Promise<void>;
  ...
  ToolResultForSession(arg0: string, arg1: string): Promise<ToolResultData | null>;
